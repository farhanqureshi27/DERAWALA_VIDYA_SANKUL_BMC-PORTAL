...
<div id="portal-section" style="display:none;">
    ...
    <div id="tab-neg" class="container">
        ...
        <div class="panel" style="border-top: 5px solid var(--neg);">
            <h2 style="color:var(--neg);">⚠️ Negative BMC Entry</h2>
    ...
    <div id="tab-pos" class="container">
        ...
        <div class="panel" style="border-top: 5px solid var(--pos);">
            <h2 style="color:var(--pos);">🏆 Positive BMC Entry</h2>
    ...
    <div id="tab-ana" class="container">
        ...
        <div class="panel">
            ...
            <button class="btn btn-main" onclick="downloadReport()">📥 Download Report</button>
        </div>
    </div>
        ...
        <div class="panel">
            ...
            <div class="form-group">
                ...
                <select id="manageAction" onchange="showManageSection()">
                    ...
                    <option value="system-reset" class="reset-only">⚠️ Full System Reset</option>
                </select>
            </div>
...
<script>
    ...
    function applyBranding() {
        ...
        // Update header
        document.getElementById('headerTitle').innerHTML = `🏫 ${branding.schoolName}`;
        ...
        container.innerHTML = db.config.classes.map(cls => `
            <div class="config-item">
                ...
                <div class="config-item-actions">
                    ${hasAdminPrivileges() ? `<button class="icon-btn delete-btn" onclick="deleteClass('${cls}')" title="Delete">🗑️</button>` : ''}
                </div>
            </div>
        `).join('');
    }
            ...
            <div style="margin-bottom: 20px;">
                ...
                ${db.config.behaviorIssues[grade].map(issue => `
                    <div class="config-item">
                        ...
                        <div class="config-item-actions">
                            ${hasAdminPrivileges() ? `<button class="icon-btn delete-btn" onclick="deleteIssue('${grade}', '${issue.id}')" title="Delete">🗑️</button>` : ''}
                        </div>
                    </div>
                `).join('')}
            </div>
    ...
    function showManageSection() {
        ...
        if (action === 'view-teachers') {
            ...
            content.innerHTML = `
                <button class="btn btn-main" onclick="exportAllData()">📥 Export Complete Database</button>
            `;
            ...
            content.innerHTML = `
                ...
                <button class="btn btn-danger" onclick="performSystemReset()">🗑️ Reset Entire System</button>
            `;
        } else {
            content.innerHTML = '';
        }
